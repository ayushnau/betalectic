    ...
    return (
        <>
            <div className="masterContainer p-10 md:p-0">
                    ...
                    <div className="flex card items-center xl:flex-col">
                        <div className="w-64 h-64 relative p-1 fteamImage bg-blue rounded-full">
                            <div className='w-60 absolute top-8 left-1'>
                                <Image className='object-cover w-full h-full' src={person2} /></div></div>
                        <div className=" aboutteam mx-5 w-3/5 sm:w-5/6">
                ...
                <div className="font-Roboto mb-28 row flex justify-center md:flex-col">
                    <div className="flex card items-center xl:flex-col">
                        <div className="w-64 h-64   p-1 relative fteamImage bg-blue rounded-full"><div className='w-60 absolute top-8 left-1'><Image className='object-cover w-full h-full' src={person3} /></div></div>
                        <div className=" aboutteam mx-5 w-3/5 sm:w-5/6">
                    ...
                    <div className="flex card items-center xl:flex-col">
                        <div className="w-64 h-64   p-1 relative fteamImage bg-blue rounded-full"><div className='w-60 absolute top-8 left-1'><Image className='object-cover w-full h-full' src={person4}/></div></div>
                        <div className=" aboutteam mx-5 w-3/5 sm:w-5/6">
                ...
                <div className="font-Roboto mb-28 row flex justify-center md:flex-col">
                    <div className="flex card items-center xl:flex-col">
                        <div className="w-64 h-64   p-1 relative fteamImage bg-blue rounded-full"><div className='w-60 absolute top-8 left-1'><Image className='object-cover w-full h-full' src={person5} /></div></div>
                        <div className=" aboutteam mx-5 w-3/5 sm:w-5/6">
                            <div className="teampost mb-4 text-lg font-light">SOFTWARE ENGINEER</div>
                    ...
                    <div className="flex card items-center xl:flex-col">
                        <div className="w-64 h-64   p-1 relative fteamImage bg-blue rounded-full"><div className='w-60 absolute top-8 left-1'><Image className='object-cover w-full h-full' src={person6}/></div></div>
                        <div className=" aboutteam mx-5 w-3/5 sm:w-5/6">
                            <div className="teampost mb-4 text-lg font-light">SOFTWARE ENGINEER</div>
                ...
                <div className="font-Roboto mb-28 row flex justify-center md:flex-col">
                    <div className="flex card items-center xl:flex-col">
                        <div className="w-64 h-64   p-1 relative fteamImage bg-blue rounded-full"><div className='w-60 absolute top-8 left-1'><Image className='object-cover w-full h-full' src={person7} /></div></div>
                        <div className=" aboutteam mx-5 w-3/5 sm:w-5/6">
                            <div className="teampost mb-4 text-lg font-light">SOFTWARE ENGINEER</div>
                    ...
                    <div className="flex card items-center xl:flex-col">
                        <div className="w-64 h-64   p-1 relative fteamImage bg-blue rounded-full"><div className='w-60 absolute top-8 left-1'><Image className='object-cover w-full h-full' src={person8}/></div></div>
                        <div className=" aboutteam mx-5 w-3/5 sm:w-5/6">
                            <div className="teampost mb-4 text-lg font-light">SOFTWARE ENGINEER</div>
                ...
                <div className="font-Roboto mb-28 row flex justify-center md:flex-col">
                    <div className="flex card items-center xl:flex-col">
                        <div className="w-64 h-64   p-1 relative fteamImage bg-blue rounded-full"><div className='w-60 absolute top-8 left-1'><Image className='object-cover w-full h-full' src={person9} /></div></div>
                        <div className=" aboutteam mx-5 w-3/5 sm:w-5/6">
                    ...
                    <div className="flex card items-center xl:flex-col">
                        <div className="w-64 h-64   p-1 relative fteamImage bg-blue rounded-full"><div className='w-60 absolute top-8 left-1'><Image className='object-cover w-full h-full' src={person10}/></div></div>
                        <div className=" aboutteam mx-5 w-3/5 sm:w-5/6">
